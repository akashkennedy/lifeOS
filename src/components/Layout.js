...
export function Layout({ children, activeSection, onSectionChange, onSignOut }) {
    ...
    return (_jsxs("div", { className: "min-h-screen flex flex-col md:flex-row bg-surface dark:bg-surface-dark", children: [!isMobile && (_jsxs("aside", { className: "w-64 border-r border-border dark:border-gray-800 flex flex-col", children: [_jsxs("div", { className: "p-6 border-b border-border dark:border-gray-800", children: [_jsx("h1", { className: "text-2xl font-bold text-[#1a1a1a] dark:text-white", children: "LifeOS" }), _jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400 mt-1", children: getTodayFormatted() })] }), _jsx("nav", { className: "flex-1 p-4", children: _jsx("ul", { className: "space-y-1", children: navItems.map((item) => {
                                const Icon = item.icon;
                                const isActive = activeSection === item.id;
                                return (_jsx("li", { children: _jsxs("button", { onClick: () => onSectionChange(item.id), className: `w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-150 ${isActive
                                            ? 'bg-accent/10 text-accent border-l-4 border-accent -ml-1 pl-5'
                                            : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800'}`, children: [_jsx(Icon, { size: 20 }), _jsx("span", { className: "font-medium", children: item.label })] }) }, item.id));
                            }) }) }), onSignOut && (_jsx("div", { className: "p-4 border-t border-border dark:border-gray-800", children: _jsxs("button", { onClick: onSignOut, className: "w-full flex items-center gap-3 px-4 py-3 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all duration-150", children: [_jsx(LogOut, { size: 20 }), _jsx("span", { className: "font-medium", children: "Sign Out" })] }) }))] })), _jsxs("main", { className: "flex-1 pb-20 md:pb-0", children: [_jsx("header", { className: "md:hidden sticky top-0 z-40 bg-surface dark:bg-surface-dark border-b border-border dark:border-gray-800 px-4 py-3", children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h1", { className: "text-xl font-bold text-[#1a1a1a] dark:text-white", children: "LifeOS" }), _jsxs("div", { className: "flex items-center gap-3", children: [_jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: getTodayFormatted() }), onSignOut && (_jsx("button", { onClick: onSignOut, className: "p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300", children: _jsx(LogOut, { size: 20 }) }))] })] }) }), _jsx("div", { className: "p-6 md:p-8", children: children })] }), isMobile && (_jsx("nav", { className: "fixed bottom-0 left-0 right-0 bg-white dark:bg-surface-dark border-t border-border dark:border-gray-800 z-50", children: _jsx("ul", { className: "flex justify-around py-2", children: navItems.map((item) => {
                        const Icon = item.icon;
                        const isActive = activeSection === item.id;
